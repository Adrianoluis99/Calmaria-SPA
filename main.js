...
function gerenciarFocoModal(modalId) {
  ...
  modal.addEventListener("keydown", (event) => {
    if (event.key === "Tab") {
      if (event.shiftKey) {
        // Se a tecla Shift+Tab for pressionada, e o foco estiver no primeiro elementosModal, mover para o último
        ...
        // Se a tecla Tab for pressionada, e o foco estiver no último elementosModal, mover para o primeiro
        event.preventDefault();
        primeiroElemento.focus();
      }
    }
